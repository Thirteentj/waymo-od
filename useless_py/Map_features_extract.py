...
if __name__ == '__main__':
    ...
    for i in tqdm(range(len(file_index_list))):
        ...
        for one_scenario in segment_dataset:  # one_scenario 就是一个scenario
            ...
            df_single_scenario_map_point = map_lane_point_extract(map_features, file_index,
            ...
            single_scenario_all_lane_entry_exit_info, single_map_dict, lane_turn_left_id, lane_turn_right_id = map_topo_info_extract(map_features)  #车道拓扑关系提取
            ...
            target_lane = [127,132,133,135,147,148,167,179,207,224,225,227,229,230,234,237]
            road_edge_count, lane_count, road_line, all_element_count = plot_top_view_single_pic_map(scenario_trj,file_index, scenario_label,
                                                                                                     scenario, lane_turn_left_id, lane_turn_right_id,length,target_lane)
